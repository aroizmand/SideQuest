  ...
  return (
    <Screen>
      <View style={styles.header}>
        <Text style={styles.heading}>Your Quests</Text>
      </View>
      {loading
        ...
        : (
          <FlatList
            ...
            renderItem={({ item }) => (
              <QuestRow quest={item} onPress={() => router.push(`/my-quests/quest/${item.quest_id}`)} />
            )}
            contentContainerStyle={styles.list}
            ListEmptyComponent={<Text style={styles.empty}>Nothing here yet. Go explore and join a quest! 🧭</Text>}
